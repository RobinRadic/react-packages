...
import { Cache, defaultRenderer, shallowCompare } from 'react-typestyle';
    ...
    return function () {
        ...
        var StyledComponent = /** @class */ (function (_super) {
            ...
            StyledComponent.prototype.render = function () {
                ...
                var computedClassName = style$1.apply(void 0, cssObjects);
                return React.createElement(tag, __assign({}, rest, { className: classes(computedClassName, className) }), children);
            };
    ...
    return function (Component, componentOptions) {
        ...
        return _a = /** @class */ (function (_super) {
                ...
                function class_1() {
                    ...
                    _this.classNames = {};
                    _this.registry = new Cache({ plugins: plugins }).register(sheet);
                    return _this;
                }
                ...
                class_1.prototype.render = function () {
                    return React.createElement(Component, __assign({ className: classes(this.classNames.root) }, this.props));
                };
                /** Update styles */
            ...
            WrappedComponent.prototype.render = function () {
                ...
                if (Component.styles !== undefined) {
                    Object
                        ...
                        return styledProps.classNames[className] = style$1(Component.styles[className]);
                    });
                }
                var className = [];
                if (Component.style !== undefined) {
                    className.push(style$1(Component.style));
                }
                if (props.className) {
                    className.push(props.className);
                }
                styledProps.className = classes.apply(void 0, className);
...
export { styled, Styled, createThemeProvider };
