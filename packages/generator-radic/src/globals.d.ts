declare interface IPackageJSON extends Object {
 ...
 */
declare interface IDependencyMap {
 ...
 */
declare interface IDirectories {
    lib?: string;
    bin?: string;
    man?: string;
    doc?: string;
...
declare interface IEngines {
    node?: string;
    npm?: string;
}

declare interface IPublishConfig {
    registry?: string;
}
